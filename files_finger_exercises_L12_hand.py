...
class Hand(object):
    ...
    def isValidWord(self,word):
        ...
        for letter in wordDict.keys():
            if self.hand.get(letter,0) == 0 or wordDict[letter] > self.hand[letter]:
                return False
        else:
            return True
    ...
    def update(self, word):
        ...
        for letter in self.hand.keys():
            testHand[letter] -= wordDict.get(letter,0)
        for letter in testHand.keys():
            if testHand[letter] > 0:
                newHand[letter] = testHand[letter]
        self.hand = newHand
        return True

...
class Family(object):
    ...
    def cousin(self, a, b):
        ...
        """
        ## YOUR CODE HERE ####
        def descendance(descendant, parent):
            distance = 0
        ...
        if a == b:
            return (-1, 0)
        elif descendance(a,b) != None:
            #return (-1, 0)
            return (-1,descendance(a,b))
        elif descendance(b,a) != None:
            #return (-1, 0)
            return (-1,descendance(b,a))
        else:
            distance_a = descendance(a,self.root)
            distance_b = descendance(b,self.root)
            if distance_a > distance_b:
                return (distance_b, distance_a - distance_b)
            elif distance_a < distance_b:
                return (distance_a, distance_b - distance_a)
            else:
                return (distance_a, 0)
...
t, r = f.cousin("a", "b")
print "'a' is a", words[t], "cousin", r, "removed from 'b'"
